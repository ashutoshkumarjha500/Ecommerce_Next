  ...
  useEffect(() => {
    (() => {
      ...
      if (SettingStateData.length) {
        setSetting({
          siteName: SettingStateData[0].siteName
            ? SettingStateData[0].siteName
            : setting.siteName,
          map1: SettingStateData[0].map1
            ? SettingStateData[0].map1
            : setting.map1,
          map2: SettingStateData[0].map2
            ? SettingStateData[0].map2
            : setting.map2,
          address: SettingStateData[0].address
            ? SettingStateData[0].address
            : setting.address,
          email: SettingStateData[0].email
            ? SettingStateData[0].email
            : setting.email,
          phone: SettingStateData[0].phone
            ? SettingStateData[0].phone
            : setting.phone,
          whatsapp: SettingStateData[0].whatsapp
            ? SettingStateData[0].whatsapp
            : setting.whatsapp,
          twitter: SettingStateData[0].twitter
            ? SettingStateData[0].twitter
            : setting.twitter,
          facebook: SettingStateData[0].facebook
            ? SettingStateData[0].facebook
            : setting.facebook,
          youtube: SettingStateData[0].youtube
            ? SettingStateData[0].youtube
            : setting.youtube,
          instagram: SettingStateData[0].instagram
            ? SettingStateData[0].instagram
            : setting.instagram,
          linkedin: SettingStateData[0].linkedin
            ? SettingStateData[0].linkedin
            : setting.linkedin,
        });
      }
    })();
            ...
            <div className="col-lg-5">
              <div className="card border-dark p-3 mb-1">
                <div className="d-flex">
                  ...
                  <div className="ms-4">
                    <h5>Address</h5>
                    <Link href={setting.map2} target="_blank" rel="noreferrer">
                      {setting.address}
                    </Link>
                  </div>
                </div>
              ...
              <div className="d-flex pt-2 mb-4">
                <Link
                  className="btn btn-outline-dark btn-square border-2 me-2"
                  href={setting.twitter}
                >
                  <i className="text-dark fab fa-twitter"></i>
                </Link>
                <Link
                  className="btn btn-outline-dark btn-square border-2 me-2"
                ...
                >
                  <i className="text-dark fab fa-youtube"></i>
                </Link>
                <Link
                  className="btn btn-outline-dark btn-square border-2 me-2"
                  href={setting.instagram}
                >
                  <i className="text-dark fab fa-instagram"></i>
                </Link>
                <Link
                  className="btn btn-outline-dark btn-square border-2 me-2"
                  href={setting.linkedin}
                >
                  <i className="text-dark fab fa-linkedin-in"></i>
                </Link>
              </div>
            </div>
                    ...
                    <div className="col-12">
                      <div className="form-floating">
                        <textarea
                          className={`form-control ${show && errorMessage.name ? "border-danger" : "border-dark"}`}
                          onChange={getInputData}
                          nameaceholder="Leave a message here"
                          name="message"
                          value={data.message}
                          style={{ height: "150px" }}
                        ></textarea>
