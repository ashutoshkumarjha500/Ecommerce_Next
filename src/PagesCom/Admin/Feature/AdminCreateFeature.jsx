            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='border p-2 text-center'>Create Feature <Link href="/admin/feature"> <i className='fa fa-arrow-left float-end'></i></Link></h5>
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-3">
                                    ...
                                    <textarea type="text" name="shortDescription" onChange={getInputData} placeholder='Short Description' rows={3} className={`${show && errorMessage.shortDescription ? 'border-danger' : ''} form-control`}></textarea>
                                    {show && errorMessage.shortDescription ? <p className='text-danger'>{errorMessage.shortDescription}</p> : null}
                                </div>

                                <div className="col-lg-6 mb-3">
                                    <label>Icon*</label>
                                    <input type="text" name="icon" onChange={getInputData} placeholder='eg. <i class="fab-fa-list"></i>' className={`${show && errorMessage.icon ? 'border-danger' : ''} form-control`} />
