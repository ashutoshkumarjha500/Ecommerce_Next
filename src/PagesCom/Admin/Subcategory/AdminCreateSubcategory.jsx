        ...
        if (error)
            ...
            if (item) {
                ...
                setErrorMessage(old => {
                    return {
                        ...old,
                        'name': 'Subcategory With This Name Already Exist'
                    }
                })
            }
            else {
                ...
                navigate.push("/admin/subcategory")
            }
        }
    }
            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='border p-2 text-center'>Create Subcategory <Link href="/admin/subcategory"> <i className='fa fa-arrow-left float-end'></i></Link></h5>
