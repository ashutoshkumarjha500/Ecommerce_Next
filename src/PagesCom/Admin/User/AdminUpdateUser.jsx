                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <label>Phone*</label>
                                    <input type="text" name="phone" value={data.phone} onChange={getInputData} placeholder='Phone Number' className={`${show && errorMessage.phone ? 'border-danger' : ''} form-control`} />
