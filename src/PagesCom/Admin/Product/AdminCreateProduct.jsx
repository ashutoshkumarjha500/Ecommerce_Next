            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='border p-2 text-center'>Create Product <Link href="/admin/product"> <i className='fa fa-arrow-left float-end'></i></Link></h5>
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-lg-6 mb-3">
                                    ...
                                    <input type="number" name="basePrice" onChange={getInputData} placeholder='Base Price' className={`${show && errorMessage.basePrice ? 'border-danger' : ''} form-control`} />
                                    {show && errorMessage.basePrice ? <p className='text-danger'>{errorMessage.basePrice}</p> : null}
                                </div>

                                <div className="col-lg-6 mb-3">
                                    <label>Discount*</label>
                                    <input type="number" name="discount" onChange={getInputData} placeholder='Discount' className={`${show && errorMessage.discount ? 'border-danger' : ''} form-control`} />
                                ...
                                <div className="col-lg-4 mb-3">
                                    ...
                                    <input type="number" name="stockQuantity" onChange={getInputData} placeholder='Stock Quantity' className={`${show && errorMessage.stockQuantity ? 'border-danger' : ''} form-control`} />
