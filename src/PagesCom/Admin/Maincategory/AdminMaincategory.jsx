            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='border p-2 text-center'>Maincategory <Link href="/admin/maincategory/create"> <i className='fa fa-plus float-end'></i></Link></h5>
                                ...
                                <tbody>
                                    {
                                        MaincategoryStateData.map(item => {
                                            return <tr key={item.id}>
                                                ...
                                                <td><Link className='btn btn-primary' href={`/admin/maincategory/update/${item.id}`}><i className='fa fa-edit'></i></Link></td>
